      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter"  @click="checkIndex=index;selectedAddressId=item.addressId" v-bind:class="{'check':checkIndex==index}">
                  <dl>
                    <dt>{{item.userName}}</dt>
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" href="javascript:;" @click="clickMore()" v-bind:class="{'open':limit==3}">
                more
                <i class="i-up-down">
      ...
      init(){
        axios.get('/users/addressList').then((response)=>{
          ...
          if(res.status=='0'){
              ...
              //解决刚加载地址页后不更改地址就继续操作next按钮提交订单导致的传参his.selectedAddressId为空的现象
